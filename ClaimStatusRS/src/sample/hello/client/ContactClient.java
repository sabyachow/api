...
public class ContactClient {
	...
	public static void main(String[] args) {
		...
		WebResource r = c.resource("http://localhost:8080/ClaimStatusRSWeb/rest/contacts/");
...
//		postForm(r, "foo", "bar");
		...
		Address[] addrs = {
			new Address("Connecticut", "Ivy Ln")
		};
		Contact cnt = new Contact("guoqing", "Sabya Qing", Arrays.asList(addrs));
